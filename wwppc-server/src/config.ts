...
if (!fs.existsSync(configPath)) fs.writeFileSync(configPath, `{
    "hostname": "wwppc.tech",
    "emailAddress": "no-reply@wwppc.tech",
    "port": 8000,
    "serveStatic": false,
    "maxConnectPerSecond": 5,
    "maxSignupPerMinute": 1,
    ...
    "dbCacheTime": 60000,
    "dbProblemCacheTime": 600000,
    "graderTimeout": 180000,
    "acceptedLanguages": [
        "Java8",
        "Java11",
        "Java17",
    ...
    "logEmailActivity": true,
    "debugMode": false,
    "superSecretSecret": false
}`, 'utf8');

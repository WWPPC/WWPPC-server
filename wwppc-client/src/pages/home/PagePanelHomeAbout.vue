...
<template>
    <div class="fullBlock">
        ...
        <div class="aboutCreditsTable">
            ...
            <HomeAboutCreditsCard name="Maitian Sha" roles="Problemsetter" img="/img/maitian-sha.jpg" codeforces="spuh" github="SampleProvider" discord="706967946198777867" youtube="watch?v=dQw4w9WgXcQ"></HomeAboutCreditsCard>
        </div>

...
<template>
    <div class="fullBlock">
        ...
        <div class="aboutCreditsTable">
            ...
            <HomeAboutCreditsCard name="Erik Ji" roles="Full Stack Developer<br>Problemsetter<br>Lead Outreach" img="/img/erikji.jpg" codeforces="passwordisa" github="erikji" discord="688018118492291080"></HomeAboutCreditsCard>
